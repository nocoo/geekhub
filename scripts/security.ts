...
const snapshot = mkdtempSync(join(tmpdir(), "geekhub-secrets-"));
try {
	...
	// Scan the reviewable working tree, including the archive, without node_modules, local secrets or generated artifacts.
	const commands = [
		[
			"gitleaks",
			"dir",
